...
namespace Wt {
    namespace Auth {
        ...
        public:
            ...
            /*! \brief Returns the registration type.
             *
             * \sa setRegistrationType()
             */
            RegistrationType registrationType() const {
        ...
        private:
            ...
            RegistrationType registrationType_;
