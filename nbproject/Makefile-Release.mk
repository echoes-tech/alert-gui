...
${OBJECTDIR}/src/HelpWidget.o: src/HelpWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HelpWidget.o src/HelpWidget.cpp
...
${OBJECTDIR}/src/MessagesTableAlertWidget.o: src/MessagesTableAlertWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessagesTableAlertWidget.o src/MessagesTableAlertWidget.cpp

${OBJECTDIR}/src/MessagesTableHistoricWidget.o: src/MessagesTableHistoricWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessagesTableHistoricWidget.o src/MessagesTableHistoricWidget.cpp

${OBJECTDIR}/src/MessagesTableMessageWidget.o: src/MessagesTableMessageWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessagesTableMessageWidget.o src/MessagesTableMessageWidget.cpp

${OBJECTDIR}/src/MessagesWidget.o: src/MessagesWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessagesWidget.o src/MessagesWidget.cpp
