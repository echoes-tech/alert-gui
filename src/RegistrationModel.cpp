...
const WFormModel::Field RegistrationModel::ChoosePasswordField = "choose-password";

const WFormModel::Field RegistrationModel::RepeatPasswordField = "repeat-password";

const WFormModel::Field RegistrationModel::EmailField = "email";

const WFormModel::Field RegistrationModel::TestField = "test";

const WFormModel::Field RegistrationModel::FirstNameField = "first-name";
const WFormModel::Field RegistrationModel::LastNameField = "last-name";
const WFormModel::Field RegistrationModel::OrganizationTypeCompanyField = "organization-type-company";
const WFormModel::Field RegistrationModel::OrganizationTypeIndividualField = "organization-type-individual";
const WFormModel::Field RegistrationModel::OrganizationTypeAssociationField = "organization-type-association";
const WFormModel::Field RegistrationModel::OrganizationNameField = "organization-name";
...
void RegistrationModel::reset()
{
    ...
    addField(OrganizationTypeCompanyField, WString::tr("Wt.Auth.organization-type-company-info"));
    addField(OrganizationTypeIndividualField, WString::tr("Wt.Auth.organization-type-individual-info"));
    addField(OrganizationTypeAssociationField, WString::tr("Wt.Auth.organization-type-association-info"));
    
    addField(OrganizationNameField, WString::tr("Wt.Auth.organization-name-info"));
    ...
    addField(FirstNameField, WString::tr("Wt.Auth.first-name-info"));
    
    addField(LastNameField, WString::tr("Wt.Auth.last-name-info"));
    ...
    addField(TestField, WString::tr("test"));
...
void RegistrationModel::setRegistrationType(RegistrationType type)
{
    registrationType_ = type;
}
...
bool RegistrationModel::isVisible(Field field) const
{
    ...
    else if (field == ChoosePasswordField || field == RepeatPasswordField)
    {
        return passwordAuth() && !idpIdentity_.isValid();
            ...
            || field == OrganizationTypeAssociationField 
            || field == OrganizationTypeIndividualField 
            || field == OrganizationTypeCompanyField 
...
//        Wt::log("info") << "YAAAAAAAAAAAAAAAAAAAAAAAAHHHHHHHHHHHHHHHHHHHHHH " << user.;
