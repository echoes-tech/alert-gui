...
void WFormModel::setReadOnly(Field field, bool readOnly)
{
  ...
  if (i != fields_.end())
    ...
    Wt::log("error") << "setReadOnly(): " << field << " not in model";
}
...
void WFormModel::setVisible(Field field, bool visible)
{
  ...
  if (i != fields_.end())
    ...
    Wt::log("error") << "setVisible(): " << field << " not in model";
}
...
void WFormModel::setValidator(Field field, WValidator *validator)
{
  ...
  if (i != fields_.end()) {
    ...
    Wt::log("error") << "setValidator(): " << field << " not in model";
}
...
void WFormModel::setValidated(Field field, bool validated)
{
  ...
  if (i != fields_.end())
    ...
    Wt::log("error") << "setValidated(): " << field << " not in model";
}
			       ...
			       const WValidator::Result& result)
{
  ...
  if (i != fields_.end()) {
    ...
    Wt::log("error") << "setValidation(): " << field << " not in model";
}
